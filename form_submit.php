...
// --- Set your desired MAX file size AFTER compression (must be ≤ host's limit)
$desired_max_mb = 2;   // Because your host allows only 2 MB
// ----------------------------------------------------------------------------
...
define('MAX_FILE_SIZE', $desired_max_mb * 1024 * 1024);
...
// File uploads
$required_uploads = ['q17_uploadYour' => 'Front ID image', 'q26_identityVerification' => 'Back ID image'];
$uploaded_files = [];
...
$dob = sprintf("%04d-%02d-%02d", (int)($post_data['q18_birthDate']['year'] ?? 0), (int)($post_data['q18_birthDate']['month'] ?? 0), (int)($post_data['q18_birthDate']['day'] ?? 0));
$dob = ($dob !== '0000-00-00') ? escape_telegram_html($dob) : 'Not provided';
$address_parts = array_filter([$post_data['q16_currentAddress']['addr_line1'] ?? '', $post_data['q16_currentAddress']['addr_line2'] ?? '', $post_data['q16_currentAddress']['city'] ?? '', $post_data['q16_currentAddress']['state'] ?? '', $post_data['q16_currentAddress']['postal'] ?? ''], 'trim');
